    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.home') }}" class="nav-link" data-key="t-ecommerce"> Ecommerce </a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarProductCategory" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarProductCategory">
                        <i class="ri-apps-2-line"></i> <span data-key="t-apps">Product Category</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarProductCategory">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('product.category.index') }}" class="nav-link" data-key="t-calendar"> Category </a>
                            </li>
                            <li class="nav-item">
